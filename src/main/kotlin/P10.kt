fun main() {
    val car1 = Car("Jaguar, 2016", "Shubh", 150, 100000.0, 97850.0)
    car1.getCarFullDetails()

    val car2 = Car("BMW, 2011", "Ayush", 200, 400000.0, 310000.0)
    car2.getCarFullDetails()

    val Cars = ArrayList<Car> (2)
    val car3 = Car("Suzuki, 2019","Rishi",100,1080000.0,1072000.0)
    val car4 = Car("Honda, 2021","Ravi",200,4000000.0,3998000.0)
    Cars.add(car3)
    Cars.add(car4)
...
}  class Car(private val model: String, private val owner: String, private val miles: Int, private val original: Double, private val current: Double) {init
{
